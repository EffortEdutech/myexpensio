...
$targetFile = Join-Path $targetDir 'db-runtime-audit.ps1'
...
Write-Host "Rewrote: $targetFile" -ForegroundColor Green
Write-Host "Now run:" -ForegroundColor Cyan
Write-Host "powershell -ExecutionPolicy Bypass -File .\scripts\db-runtime-audit.ps1"
