'use client'
// apps/cs/app/(protected)/templates/TemplatesClient.tsx
//
...
export default function TemplatesClient({
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    try {
      ...
      const url    = isEdit ? `/api/console/templates/${editTarget!.id}` : '/api/console/templates'
  ...
  async function handleToggleActive(t: Template) {
    ...
    try {
      const res  = await fetch(`/api/console/templates/${t.id}`, {
  ...
  async function handleDelete(t: Template) {
    ...
    setBusyTemplate(t.id)
    try {
      const res  = await fetch(`/api/console/templates/${t.id}`, { method: 'DELETE' })
      const json = await res.json()
  ...
  async function handleAssign(templateId: string, makeDefault: boolean) {
    ...
    try {
      const res  = await fetch('/api/console/template-assignments', {
